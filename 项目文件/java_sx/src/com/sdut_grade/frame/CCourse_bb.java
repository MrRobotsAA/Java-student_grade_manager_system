...
import com.Print;
import com.javen.excel.TestDbToExcel;
...
public class CCourse_bb extends JDialog {
	...
	private JButton jButton_ok1 = null;
	...
	public CCourse_bb() {
		...
		jButton_ok1.addActionListener(new btnListener());
...
//		});
		...
		jButton_ok.setBounds(new Rectangle(100, 130, 92, 26));
		jButton_ok.setText("输出表格");
		jButton_ok.setFont(new Font("粗体",Font.BOLD,12));
		
		jButton_ok1 = new JButton();
		jButton_ok1.setBounds(new Rectangle(340, 130, 92, 26));
		jButton_ok1.setText("直接打印");
		jButton_ok1.setFont(new Font("粗体",Font.BOLD,12));
		...
		jContentPane.add(jButton_ok1, null);
	...
	public class btnListener implements ActionListener {
		private int tmp2;
		private TestDbToExcel exm;
		private TestDbToExcel exm2;
		private Print exm3;
...
//
//				//	}
				String tmp = jComboBox_class.getSelectedItem().toString();
				ClassDao p = new ClassDao();
				System.out.println(tmp);
				tmp2 = p.getClassNameByClassName(tmp);
				//String tmp3 = p.getClassNameByClassId(3);
				System.out.println(tmp2);
				System.out.print("fdsf");
				exm = new TestDbToExcel(tmp2);
				JOptionPane.showMessageDialog(null,"报表输出成功","确认对话框",
                        JOptionPane.WARNING_MESSAGE);
				
						
			} else if (e.getSource() == jButton_ok1){
				...
				exm2 = new TestDbToExcel(tmp2);
				exm3 = new Print();
				JOptionPane.showMessageDialog(null,"报表打印成功","确认对话框",
                        JOptionPane.WARNING_MESSAGE);
			}
